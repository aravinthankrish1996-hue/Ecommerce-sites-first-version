    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">ADD Attributer</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">ADD Attributer</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
            	...
            	<h6 class="mb-0 text-uppercase">ADD Attributer</h6>
				<hr/>
                <div class="col">
						<button type="button" onclick="saveData('','','')" class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Attributer</button>
									</div>
				<div class="card">
					<div class="card-body">
							...
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
									...
									<td>{{$list->updated_at}}</td>
                                        ...
                                        <button onclick="deleteData('{{ $list->id }}',`attributers`)" class="btn btn-outline-danger px-5 radius-30">Delete</button>
                                        </td>
                                  </tr>
                                  @endforeach
								</tbody>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalLabel">Attributer</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
            <form id="formSubmit" action="{{ url('update_attributer_name') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="border p-4 rounded">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="slug" class="form-control" id="enter_slug" placeholder="Enter slug" required data-parsley-required-message="Text field is required.">
                            </div>
                        </div>
