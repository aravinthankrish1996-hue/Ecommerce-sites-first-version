...
@section("content")
    {{-- Place this in your master layout file if it applies globally --}}
    {{-- Otherwise, ensure it's in the <head> section of this Blade file --}}
    @push('head_scripts')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <hr/>
                <div class="col">
                    {{-- When adding, pass empty strings for all fields --}}
                            ...
                            <table id="example2" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($list->image)
                                                <img src="{{ asset('images/' . $list->image) }}" alt="Banner Image" width="50px" height="50px" onerror="this.onerror=null; this.src='{{ asset('images/no-image.png') }}';">
                                            @else
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form id="formSubmit" action="{{ url('updateHomeBanner') }}" method="post" enctype="multipart/form-data">
                @csrf
...
// Populate modal
function saveData(id, text, link, imageFileName) {
