    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
				...
				<hr/>
                <div class="col">
										<button type="button"  onclick="saveData('0','')"  class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal" data-bs-target="#exampleModal">Add New Size</button>
									</div>
				<div class="card">
					<div class="card-body">
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form id="formSubmit" action="{{ url('updatesize') }}" method="post" enctype="multipart/form-data">
                @csrf
