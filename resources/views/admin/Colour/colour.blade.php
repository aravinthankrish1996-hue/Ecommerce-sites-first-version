    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <hr/>
                <div class="col">
                    <button type="button" onclick="saveData('','','')" class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal" data-bs-target="#exampleModal">Add New Color</button>
                </div>
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="example2" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $list->id }}</td>
                                        <td>{{$list->text}}</td>
                                        <td class="box_color"style="background-color:{{ $list->value }}">Color</td>
                                        ...
                                        <td>
                                            ...
                                            <button onclick="deleteData('{{ $list->id }}',`colours`)" class="btn btn-outline-danger px-5 radius-30">Delete</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form id="formSubmit" action="{{ url('updatecolor') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="border p-4 rounded">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="value" class="form-control" id="enter_value" placeholder="Enter Text" required data-parsley-required-message="Text field is required.">
                            </div>
                        </div>
