        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    {{-- Corrected Image Path for User Profile Display --}}
                                    <img src="{{ Auth::User()->image ? asset('storage/' . Auth::User()->image) : asset('images/default-profile.png') }}"
                                         id="profileImagePreview" {{-- Changed ID to avoid conflict with future image previews --}}
                                         alt="Admin"
                                         class="rounded-circle p-1 bg-primary"
                                         width="110"
                                         onerror="this.onerror=null; this.src='{{ asset('images/default-profile.png') }}';" {{-- Fallback for missing image --}}
                                    >
                                    <div class="mt-3">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-twitter me-2 icon-inline text-info"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg>X Account</h6>
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                         <form id="formSubmit" action="{{ url('/saveProfile') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">X Account</h6>
                                        </div>
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control" name="x_link" value="{{ Auth::user()->x_link }}" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            {{-- Added onchange for live preview --}}
                                            <input type="file" name="image" class="form-control" id="uploadProfileImage" onchange="previewProfileImage(event)" />
                                            {{-- Hidden input to send old image name for backend handling --}}
...
<script>
    // Function to preview image selected by user in the profile update form
    function previewProfileImage(event) {
        const reader = new FileReader();
        reader.onload = function() {
            // Update the src of the main profile image preview
    ...
    // Optional: Add onerror handler for the profile image in the main view
    // This ensures that if the image doesn't load initially (e.g., after a refresh),
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        profileImg.onerror = function() {
            ...
            this.src = "{{ asset('images/default-profile.png') }}"; // Path to your default profile image
        };
    });
        ...
        $('#formSubmit').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    // Check for the lowercase 'success' status from the ApiResponse trait
